...
//
   ...
   *
   */
  Controller.prototype.addItem = function (e, trNode) {
    var input = this.$listArea;
    this.model.read({href : trNode.dataset.href}, function (data) {
      if (data.length > 0) {
        return ;
      }
      this.model.create(trNode.dataset.href, -1, -1, function (data) {
